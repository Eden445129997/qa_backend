# Generated by Django 3.0.6 on 2020-11-12 07:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assert_obj', models.CharField(max_length=64, verbose_name='检查对象，jsonpath表达式')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_expression', models.BooleanField(default=False, verbose_name='表达式状态：0 不启用jsonpath捕捉参数化\n 1 启用jsonpath捕捉参数化')),
                ('text', models.CharField(blank=True, max_length=64, null=True, verbose_name='用例描述')),
                ('is_status', models.BooleanField(default=True, verbose_name='启用状态：0未启用 1启用')),
                ('is_delete', models.BooleanField(default=False, verbose_name='逻辑删除：1删除 0未删除')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('a', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='qa_platform.A')),
            ],
            options={
                'db_table': 'tb_B',
            },
