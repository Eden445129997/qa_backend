...
from apps.qa_platform.api_framework.http import HttpBuilder
from apps.qa_platform.api_framework.parameters import ParametersBuilder
from apps.qa_platform.api_framework.report import ReportBuilder
from apps.qa_platform.api_framework.checkpoint import CheckpointBuilder
...
class TaskDirector(threading.Thread):
    ...
    def run(self):
        ...
        # 正常的报告
        if self.report_builder.task_status != EventStatus.FAILSE.value:
