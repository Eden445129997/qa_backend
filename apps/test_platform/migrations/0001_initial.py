    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('executor', models.CharField(max_length=32, verbose_name='计划执行者')),
                ('env', models.CharField(max_length=32, verbose_name='执行任务环境')),
                ...
                ('excute_time', models.IntegerField(blank=True, null=True, verbose_name='执行使用时间')),
                ('excute_total', models.IntegerField(verbose_name='用例执行总数')),
                ('task_status', models.IntegerField(choices=[(1, 1), (2, 2), (3, 3)], verbose_name='任务状态（1、等待执行2、执行中3、执行完成）')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_header', models.TextField(default='{}', verbose_name='请求头')),
                ('input_parameter', models.TextField(default='{}', verbose_name='请求入参')),
                ('output_parameter', models.TextField(blank=True, null=True, verbose_name='响应参数')),
                ...
                ('case_sort', models.IntegerField(default=0, verbose_name='用例排序顺序')),
                ('start_time_stamp', models.BigIntegerField(verbose_name='开始时间戳')),
                ('end_time_stamp', models.BigIntegerField(verbose_name='结束时间戳')),
                ('excute_time', models.IntegerField(blank=True, null=True, verbose_name='执行使用时间')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.CharField(choices=[('POST', 'POST'), ('GET', 'GET'), ('PUT', 'PUT'), ('DELETE', 'DELETE')], max_length=255, verbose_name='请求方式')),
                ('path', models.CharField(max_length=128, verbose_name='资源路径')),
                ('defaultData', models.TextField(default='{}', verbose_name='默认入参')),
                ('text', models.CharField(blank=True, max_length=255, null=True, verbose_name='描述')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('project_name', models.TextField(max_length=64, verbose_name='项目名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('case_id', models.TextField(verbose_name='所属用例id')),
                ('path_id', models.TextField(verbose_name='请求资源地址')),
                ('reconnection_times', models.IntegerField(verbose_name='重连次数')),
                ('wait_time', models.IntegerField(verbose_name='最长等待时长')),
                ('input_header', models.TextField(default='{}', verbose_name='请求头')),
                ('input_parameter', models.TextField(default='{}', verbose_name='请求入参')),
