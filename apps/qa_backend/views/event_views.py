...
# 模型
from apps.qa_backend.models.domain import event
# 自定义模型视图
...
from apps.qa_backend.service.event_api_result_service import *
from apps.qa_backend.models import domain
# 序列化
...
class EventViews(BaseModelViewSet):
    """事件表"""
